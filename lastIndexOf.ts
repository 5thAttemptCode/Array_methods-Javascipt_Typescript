...
const shoppingHistory: string[] = ["Laptop", "Mouse", "Keyboard", "Monitor", "Mouse", "Laptop", "Mouse"]

const productToFind: string = "Mouse"

const lastPurchaseIndex: number = shoppingHistory.lastIndexOf(productToFind)
