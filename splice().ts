...
const faultyOrderIndex: number = orders.findIndex((order: Order) => order.id === 3)

if (faultyOrderIndex !== -1) {
  const removedOrders: Order[] = orders.splice(faultyOrderIndex, 1, { id: 6, customer: "Elias", date: "2023-06-24" })
